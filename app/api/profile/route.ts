...
export async function POST(req: NextRequest) {
  try {
    ...
    const preferred_currency: Currency | undefined = allowed.includes(
      body?.preferred_currency
    )
      ? (body.preferred_currency as Currency)
      : undefined
    ...
    const payload: ProfilesUpdate = {
      ...
      show_dob_year:
        typeof body.show_dob_year === 'boolean'
          ? body.show_dob_year
          : undefined,
      preferred_currency,
      notify_channel:
        typeof body.notify_channel === 'string'
          ? body.notify_channel
          : undefined,
      avatar_url:
      ...
      interests: Array.isArray(body.interests)
        ...
        : undefined,
      preferred_shops: Array.isArray(body.preferred_shops)
        ? body.preferred_shops.map(String)
        : undefined,
