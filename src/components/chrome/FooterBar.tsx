...
const ICONS = {
  linkedin:
    'M4.98 3.5C4.98 4.88 3.86 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5ZM.5 8.5h4V23h-4V8.5ZM8.98 8.5H13v2h.06c.56-1.06 1.93-2.18 3.97-2.18 4.25 0 5.03 2.8 5.03 6.45V23h-4v-6.5c0-1.55-.03-3.54-2.16-3.54-2.16 0-2.49 1.69-2.49 3.43V23h-4V8.5Z',
  facebook:
    'M14.5 8H17V4h-2.5c-3.04 0-5 1.83-5 5v2H7v4h2.5V24h4v-9H17l1-4h-3.5V9c0-.83.17-1 1-1Z',
}
