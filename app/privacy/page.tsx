...
export default function PrivacyPage() {
  return (
    <main className='mx-auto max-w-3xl px-6 py-12 prose'>
      <h1>Privacy</h1>
      <p>
        <em>Last updated: 01 October 2025</em>
      </p>
      <p>
        We keep it simple: we do not sell your data. We collect only what we
        need to run Gift Huddle and improve your experience.
      </p>
      ...
      <h2>Data sharing</h2>
      <p>
        We may use affiliate links and receive a commission if you buy. We do
