...
export async function POST(req: NextRequest) {
  try {
    ...
    const budget_input_currency: Currency | undefined = allowed.includes(body?.budget_input_currency)
    ...
    const payload: EventsInsert = {
      ...
      active_round: typeof body.active_round === "number" ? body.active_round : undefined,
      budget_input_currency,
      budget_usd_cents: typeof body.budget_usd_cents === "number" ? body.budget_usd_cents : undefined,
    };
